                                    ...
                                    <div class="modal-body">
                                        <form>
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="<s:property value="complid"/>" class="form-control" id="recipient-name">
                                            </div>
                                            <div class="form-group">
                                ...
                                <tbody>
                                    <s:iterator value="complaintList">
                                        <tr>
                                            ...
                                            <td><button type="button" class="btn btn-sm btn-outline-secondary" data-toggle="modal" data-target="#exampleModal" data-whatever="@getbootstrap" onclick ="fetchcomplaint(<s:property value="complid"/>)">View Details</button></td>
